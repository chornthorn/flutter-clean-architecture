...
void main() {
  ...
  test('should resolve the write path and its event handler', () async {
    await getIt<AddProductToCartUseCase>()('sku-42');

    // Read back through the use case, so this covers the cart side too.
    expect((await getIt<GetCartUseCase>()()).productIds, ['sku-42']);
