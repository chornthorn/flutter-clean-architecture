...
///
/// The base hands a screen's state holder the `dispose` the route calls on
/// unmount. A class that lives here without inheriting the base takes on the
/// screen's work without the screen's lifecycle, and the page leaks whatever it
/// started.
class ViewModelMustExtendBaseRule extends AnalysisRule {
  ...
  LintCode get diagnosticCode => LintCode(
    ...
    correctionMessage:
        'Extend `ViewModel`, or move the class out of `view_models/`.',
  );
